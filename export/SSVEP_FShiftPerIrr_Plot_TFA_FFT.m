...
% new experiment from participant 22 onwards (stimuli isoluminant to background and used other frequencies)
...
% only evoked
figure;
set(gcf,'Position',[100 100 200 200],'PaperPositionMode','auto')
pl.mdata = mean(pl.data_evo,2,'omitnan');
% pl.clim = [0 max(pl.mdata)];
pl.clim = [0 1.632];
